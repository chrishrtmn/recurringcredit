    ...
    <>
      <Layout pageTitle={title} description={description}>
        <main>
          ...
          <p>
            It is RecurringCredit's policy to respect your privacy regarding any
            information we may collect while operating our website. This Privacy
            Policy applies to{' '}
            <a href='https://recurringcredit.com'>
              https://recurringcredit.com
            </a>{' '}
            (hereinafter, "us", "we", or "https://recurringcredit.com"). We
          ...
          <p>
            Like most website operators, RecurringCredit collects
            non-personally-identifying information of the sort that web browsers
            and servers typically make available, such as the browser type,
            language preference, referring site, and the date and time of each
            visitor request. RecurringCredit's purpose in collecting
            non-personally identifying information is to better understand how
            RecurringCredit's visitors use its website. From time to time,
            RecurringCredit may release non-personally-identifying information
            in the aggregate, e.g., by publishing a report on trends in the
            usage of its website.
          </p>
          <p>
            RecurringCredit also collects potentially personally-identifying
            information like Internet Protocol (IP) addresses for logged in
            users and for users leaving comments on https://recurringcredit.com
            blog posts. RecurringCredit only discloses logged in user and
          ...
          <p>
            Certain visitors to RecurringCredit's websites choose to interact
            with RecurringCredit in ways that require RecurringCredit to gather
            personally-identifying information. The amount and type of
            information that RecurringCredit gathers depends on the nature of
            the interaction. For example, we ask visitors who sign up for a blog
            at https://recurringcredit.com to provide a username and email
            address.
          </p>
          <h2>Security</h2>
          <p>
          ...
          <p>
            ...
            cookies by RecurringCredit and does not cover the use of cookies by
            any advertisers.
          </p>
          ...
          <h2>
            Https://recurringcredit.com uses Google AdWords for remarketing
          </h2>
          <p>
            Https://recurringcredit.com uses the remarketing services to
          ...
          <p>
            RecurringCredit discloses potentially personally-identifying and
            personally-identifying information only to those of its employees,
            contractors and affiliated organizations that (i) need to know that
            information in order to process it on RecurringCredit's behalf or to
            provide services available at RecurringCredit's website, and (ii)
            ...
            outside of your home country; by using RecurringCredit's website,
            you consent to the transfer of such information to them.
            RecurringCredit will not rent or sell potentially
            ...
            organizations, as described above, RecurringCredit discloses
            ...
            governmental request, or when RecurringCredit believes in good faith
            that disclosure is reasonably necessary to protect the property or
            rights of RecurringCredit, third parties or the public at large.
          </p>
          <p>
            If you are a registered user of https://recurringcredit.com and have
            supplied your email address, RecurringCredit may occasionally send
            you an email to tell you about new features, solicit your feedback,
            or just keep you up to date with what's going on with
            RecurringCredit and our products. We primarily use our blog to
            ...
            request or to help us support other users. RecurringCredit takes all
          ...
          <p>
            RecurringCredit may collect statistics about the behavior of
            visitors to its website. RecurringCredit may display this
            information publicly or provide it to others. However,
            RecurringCredit does not disclose your personally-identifying
            information.
          </p>
          <h2>Cookies</h2>
          <p>
            To enrich and perfect your online experience, RecurringCredit uses
          ...
          <p>
            ...
            website each time the visitor returns. RecurringCredit uses cookies
            to help RecurringCredit identify and track visitors, their usage of
            https://recurringcredit.com, and their website access preferences.
            RecurringCredit visitors who do not wish to have cookies placed on
            their computers should set their browsers to refuse cookies before
            using RecurringCredit's websites, with the drawback that certain
            features of RecurringCredit's websites may not function properly
            without the aid of cookies.
          </p>
          <p>
            By continuing to navigate our website without changing your cookie
            settings, you hereby acknowledge and agree to RecurringCredit's use
            of cookies.
          </p>
          <h2>E-commerce</h2>
          <p>
            Those who engage in transactions with RecurringCredit – by
            purchasing RecurringCredit's services or products, are asked to
            ...
            each case, RecurringCredit collects such information only insofar as
            is necessary or appropriate to fulfill the purpose of the visitor's
            interaction with RecurringCredit. RecurringCredit does not disclose
          ...
          <p>
            Although most changes are likely to be minor, RecurringCredit may
            change its Privacy Policy from time to time, and in
            RecurringCredit's sole discretion. RecurringCredit encourages
