        ...
        */}
        ...
        <main>
          <div className='wrapper'>
            ...
            <p>RecurringCredit is located at:</p>
            ...
            <p>
              It is RecurringCredit's policy to respect your privacy regarding
            ...
            <p>
              ...
              of each visitor request. RecurringCredit's purpose in collecting
            ...
            <p>
              ...
              https://recurringcredit.com blog posts. RecurringCredit only
            ...
            <p>
              ...
              with RecurringCredit in ways that require RecurringCredit to
              ...
              blog at https://recurringcredit.com to provide a username and
              email address.
            </p>
            ...
            <p>
              ...
              covers the use of cookies by RecurringCredit and does not cover
            ...
            <p>
              ...
              own privacy policy and Google's privacy policy.
            </p>
            ...
            <p>
              ...
              that information in order to process it on RecurringCredit's
              behalf or to provide services available at RecurringCredit's
              ...
              RecurringCredit's website, you consent to the transfer of such
              information to them. RecurringCredit will not rent or sell
              ...
              and affiliated organizations, as described above, RecurringCredit
              discloses potentially personally-identifying and
              personally-identifying information only in response to a subpoena,
              court order or other governmental request, or when RecurringCredit
              believes in good faith that disclosure is reasonably necessary to
              protect the property or rights of RecurringCredit, third parties
              or the public at large.
            </p>

            <p>
              If you are a registered user of https://recurringcredit.com and
              have supplied your email address, RecurringCredit may occasionally
              ...
              RecurringCredit takes all measures reasonably necessary to protect
            ...
            <p>
              ...
              website each time the visitor returns. RecurringCredit uses
              cookies to help RecurringCredit identify and track visitors, their
              usage of https://recurringcredit.com, and their website access
              preferences. RecurringCredit visitors who do not wish to have
              cookies placed on their computers should set their browsers to
              refuse cookies before using RecurringCredit's websites, with the
              drawback that certain features of RecurringCredit's websites may
              not function properly without the aid of cookies.
            </p>

            <p>
              By continuing to navigate our website without changing your cookie
              settings, you hereby acknowledge and agree to RecurringCredit's
              use of cookies.
            </p>
            ...
            <p>
              ...
              transactions. In each case, RecurringCredit collects such
              information only insofar as is necessary or appropriate to fulfill
              the purpose of the visitor's interaction with RecurringCredit.
              RecurringCredit does not disclose personally-identifying
