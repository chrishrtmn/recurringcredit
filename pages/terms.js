      ...
      <Layout pageTitle={title} description={description}>
        ...
        <main>
          ...
          <p>
            ...
            use of RecurringCredit's Website.
          </p>{' '}
          <br />
          ...
          <p>
            ...
            conditions in full. Do not continue to use RecurringCredit's website
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using RecurringCredit's website you
            consent to the use of cookies in accordance with RecurringCredit's
            privacy policy.
          </p>
          <p>
          ...
          <p>
            ...
            RecurringCredit. All intellectual property rights are reserved. You
            may view and/or print pages from https://recurringcredit.com for
          ...
          <ol>
            ...
            <li>
              ...
              ('Comments') in areas of the website. RecurringCredit does not
              ...
              ofRecurringCredit, its agents or affiliates. Comments reflect the
              view and opinion of the person who posts such view or opinion. To
              the extent permitted by applicable laws RecurringCreditshall not
            ...
            <li>
              RecurringCreditreserves the right to monitor all Comments and to
            ...
            <li>
              You hereby grant to <strong>RecurringCredit</strong> a
          ...
          <p>
            ...
            hyperlink outweighs the absence of RecurringCredit; and (d) where
          ...
          <p>
            ...
            <a
              href='mailto:legal@recurringcredit.com'
              title='send an email to legal@recurringcredit.com'
            >
              legal@recurringcredit.com
            </a>
